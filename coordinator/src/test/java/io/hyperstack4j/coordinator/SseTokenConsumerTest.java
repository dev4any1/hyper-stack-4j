 ...
 *
 * Uses a List<String> as the SseEmitter — no Javalin needed.
 * Verifies the JSON structure of each emitted SSE data payload.
 */
class SseTokenConsumerTest {
    ...
    void empty_token_piece_is_still_emitted() {
        // Special tokens decode to empty string — still need the event for position tracking
