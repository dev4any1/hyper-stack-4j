 ...
 *
 * Defaults match the architecture spec:
 *   vramWarning  = 0.90 (90%)  → evict cold KV blocks, reduce batch size
 *   vramCritical = 0.98 (98%)  → open circuit breaker, trigger reshard
 *   staleAfterMs = 15_000      → 3 missed probes (probe interval = 5s)
 */
